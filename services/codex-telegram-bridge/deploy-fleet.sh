...
SERVICE_NAME="${SERVICE_NAME:-com.ella.codex-bridge}"
PLIST_DST="${PLIST_DST:-${HOME}/Library/LaunchAgents/com.ella.codex-bridge.plist}"
SYSTEMD_UNIT_NAME="${SYSTEMD_UNIT_NAME:-codex-telegram-bridge}"
