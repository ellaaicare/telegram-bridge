...
SERVICE_NAME="${SERVICE_NAME:-com.ella.claude-bridge}"
PLIST_DST="${PLIST_DST:-${HOME}/Library/LaunchAgents/com.ella.claude-bridge.plist}"
SYSTEMD_UNIT_NAME="${SYSTEMD_UNIT_NAME:-claude-telegram-bridge}"
